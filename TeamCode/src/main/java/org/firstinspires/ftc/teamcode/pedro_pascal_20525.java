...
public class pedro_pascal_20525 extends OpMode {
    ...
    public void init() {
        ...
        public void loop() {
            ...
            if (point == 2 && RightLift.getCurrentPosition() <= 2200) {
        ...
        public PathChain path() {
            ...
            builder.addPath(
                    // Line 1
                    new BezierLine(
                            new Point(7.971, 54.065, Point.CARTESIAN),
                            new Point(38.123, 75.726, Point.CARTESIAN)
                    )
            )
         ...
         public PathChain path1() {
             ...
             builder
                     .addPath(
                             ...
                             new BezierLine(
                                     new Point(38.123, 75.726, Point.CARTESIAN),
                                     new Point(31.365, 75.552, Point.CARTESIAN)
                             )
                     )
                     .setConstantHeadingInterpolation(Math.toRadians(0))
                     .addPath(
                             ...
                             new BezierLine(
                                     new Point(31.365, 75.552, Point.CARTESIAN),
                                     new Point(39.336, 37.083, Point.CARTESIAN)
                             )
                     )
                     .setConstantHeadingInterpolation(Math.toRadians(0))
                     .addPath(
                             ...
                             new BezierLine(
                                     new Point(39.336, 37.083, Point.CARTESIAN),
                                     new Point(62.903, 36.043, Point.CARTESIAN)
                             )
                     )
                     .setConstantHeadingInterpolation(Math.toRadians(0))
                     .addPath(
                             ...
                             new BezierLine(
                                     new Point(62.903, 36.043, Point.CARTESIAN),
                                     new Point(62.556, 28.765, Point.CARTESIAN)
                             )
                     )
                     .setConstantHeadingInterpolation(Math.toRadians(0))
                     .addPath(
                             ...
                             new BezierLine(
                                     new Point(62.556, 28.765, Point.CARTESIAN),
                                     new Point(15.769, 27.726, Point.CARTESIAN)
                             )
                     )
                     .setConstantHeadingInterpolation(Math.toRadians(0))
                     .addPath(
                     ...
                     .addPath(
                             ...
                             new BezierLine(
                                     new Point(62.556, 28.765, Point.CARTESIAN),
                                     new Point(61.863, 17.329, Point.CARTESIAN)
                             )
                     )
                     .setConstantHeadingInterpolation(Math.toRadians(0))
                     .addPath(
                             ...
                             new BezierLine(
                                     new Point(61.863, 17.329, Point.CARTESIAN),
                                     new Point(15.942, 16.462, Point.CARTESIAN)
                             )
                     )
                     .setConstantHeadingInterpolation(Math.toRadians(0))
                     .addPath(
                             ...
                             new BezierLine(
                                     new Point(15.942, 16.462, Point.CARTESIAN),
                                     new Point(61.690, 17.155, Point.CARTESIAN)
                             )
                     )
                     .setConstantHeadingInterpolation(Math.toRadians(0))
                     .addPath(
                             ...
                             new BezierLine(
                                     new Point(61.690, 17.155, Point.CARTESIAN),
                                     new Point(60.996, 9.704, Point.CARTESIAN)
                             )
                     )
                     .setConstantHeadingInterpolation(Math.toRadians(0))
                     .addPath(
                             ...
                             new BezierLine(
                                     new Point(60.996, 9.704, Point.CARTESIAN),
                                     new Point(16.635, 9.357, Point.CARTESIAN)
                             )
                     )
                     .setConstantHeadingInterpolation(Math.toRadians(0));
             return builder.build();
