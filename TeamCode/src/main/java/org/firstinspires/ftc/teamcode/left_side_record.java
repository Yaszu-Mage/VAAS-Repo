...
@TeleOp(name = "M_left_side_Record")
public class left_side_record extends LinearOpMode {
    ...
    Servo RightHClaw, LeftHClaw, HighClaw, LeftSlide, RightSlide;
    ...
    private HashMap<String, Double> robotMovement() {
        ...
        if (gamepad1.right_trigger >= 0.1 && LeftLift.getCurrentPosition() <= 3600) {
