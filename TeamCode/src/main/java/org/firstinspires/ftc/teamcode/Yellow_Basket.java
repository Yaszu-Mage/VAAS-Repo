...
@Autonomous(name = "mPlay_Yellow_Basket")
public class Yellow_Basket extends LinearOpMode {
    ...
    Servo RightHClaw, LeftHClaw, HighClaw, LeftSlide, RightSlide, Wrist,LowClaw; //Declaring variables used for motors
